	...
	<view class="">
		...
		<view class="index-wrapper" :style="colorStyle">
					...
					<scroll-view class="scroll-view_x" scroll-x style="width:auto;overflow:hidden;">
						<block v-for="(item,index) in firstList" :key='index'>
							<view class='item' @click="goDetail(item)">
								...
								<view class='money font-color'><text class="rmb">{{$t(`money`)}}</text>{{item.price}}</view>
							</view>
						</block>
					</scroll-view>
				</view>
						...
						<block v-for="(item,index) in firstList" :key='index'>
							<view class='item' @click="goDetail(item)">
								...
								<view class='money font-color'>
									<text class="rmb">{{$t(`money`)}}</text>{{item.price}}
								</view>
							</view>
						</block>
					</scroll-view>
			...
			<view class='wrapper' v-if="isIframe && !firstList.length">
				...
				<view class='newProducts'>
					<view class="empty-img">{{$t(`first_new_product`)}}</view>
				</view>
			</view>
		</view>
	</view>
