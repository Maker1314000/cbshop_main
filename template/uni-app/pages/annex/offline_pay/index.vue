				...
				orderOfflinePayType()
					.then(res => {
						...
						if (!offline_pay_status) {
							uni.showModal({
								title: this.$t(`paym_reminder`),
								content: this.$t(`offline_pay_closed`),
								showCancel: false,
								success() {
									uni.switchTab({
