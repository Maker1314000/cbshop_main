				...
				<view class="update-wrap">
					...
					<view class="content">
						...
						<view class="sche-wrap" v-else>
							...
							<text class="down-text">{{$t(`download_progress`)}}:{{ (downSize / 1024 / 1024).toFixed(2) }}M/{{
