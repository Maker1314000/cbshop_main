<template>
	<view>
		<view class="address-window" :class="address.address==true?'on':''">
			<view class='title'>{{$t(`choose_address`)}}<text class='iconfont icon-guanbi' @tap='close'></text></view>
			<view class='list'>
			...
			<view class='addressBnt bg-color' @tap='goAddressPages'>{{$t(`other_address`)}}</view>
		</view>
