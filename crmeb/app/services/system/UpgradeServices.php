...
class UpgradeServices extends BaseServices
{
    ...
    public function packageDownload(string $packageKey): bool
    {
        ...
        // 核对签名
//        $projectSignature = $this->getVersion('project_signature');
//        if (!$projectSignature) {
...
//        }
    ...
    public function checkSignature()
    {
        ...
        Log::error(['projectSignature' => $projectSignature, 'newSignature' => $newSignature, 'result' => $projectSignature == $newSignature]);
